...
export const metadata: Metadata = {
  title: "AI PPT工具推荐 - AI做PPT、Gamma、Canva、PPT Master和汇报生成教程",
  description:
    "小白AI整理AI PPT工具推荐，覆盖 Gamma、Canva AI、PPT Master、Kimi、ChatGPT 和 DeepSeek，讲清楚AI做PPT的流程、提示词、导出和汇报修改方法。",
...
export default function AiPptToolsTopicPage() {
  return (
    <SeoTopicPage
      ...
      faq={[
        { question: "AI PPT工具哪个最好用？", answer: "新手优先试 Gamma，生成速度快、结构清楚。需要设计模板可以用 Canva AI；需要原生可编辑 PPTX 可以试 PPT Master。" },
