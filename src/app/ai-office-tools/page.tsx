...
export const metadata: Metadata = {
  ...
  description:
    "小白AI整理2026主流AI办公工具推荐，覆盖 Microsoft 365 Copilot、ChatGPT、Kimi、DeepSeek、豆包、Gamma、Canva AI、Dify、n8n、Zapier 和 AI表格工具，适合PPT、会议纪要、文档总结和自动化办公。",
...
export default function AiOfficeToolsTopicPage() {
  return (
    <SeoTopicPage
      ...
      toolRefs={[
        { id: "microsoft-copilot", note: "Microsoft 365 Copilot 适合已经使用 Word、Excel、PowerPoint、Teams 的企业办公场景。" },
        { id: "chatgpt", note: "ChatGPT 适合文档分析、会议材料整理、图表说明、邮件和多轮修改。" },
        { id: "kimi", note: "Kimi 适合长文档、PDF、会议资料和合同的总结提炼。" },
        { id: "deepseek", note: "DeepSeek 适合写周报、日报、流程说明、邮件回复和数据解释。" },
        { id: "doubao", note: "豆包适合日常办公草稿、语音输入、内容润色和国内多端协同。" },
        { id: "gamma", note: "Gamma 适合从主题或大纲生成 PPT、文档和汇报页面，适合快速出草稿。" },
        { id: "canva-ai", note: "Canva AI 适合做演示、海报、封面、社媒图和模板化办公设计。" },
        { id: "dify", note: "Dify 适合把公司资料做成知识库问答、AI客服或内部办公助手。" },
        { id: "n8n-ai-agent", note: "n8n 适合把表格、邮件、飞书、企业微信和 AI 串成自动化流程。" },
        { id: "zapier-ai", note: "Zapier AI 适合连接海外 SaaS、表单、CRM、邮件和 AI 节点，快速做轻自动化。" },
      ]}
      sections={[
        {
          title: "先从高频工作开始",
        ...
        },
        {
          ...
          bullets: ["先用 ChatGPT、DeepSeek、Kimi、豆包把内容处理好。", "再用 Gamma、Canva AI、Microsoft 365 Copilot 做交付格式。", "固定问答用 Dify/Coze，流程自动化用 n8n/Zapier/Make。"],
        },
        {
          title: "企业使用注意",
      ...
      faq={[
        { question: "AI办公工具最先学哪个？", answer: "先学 ChatGPT、DeepSeek、Kimi 或豆包做总结和写作，再学 Gamma/Canva 做PPT。如果公司已经用微软生态，可以关注 Microsoft 365 Copilot；资料问答再上 Dify 或 Coze。" },
