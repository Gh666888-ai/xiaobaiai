        ...
        {filtered.length===0?(
          ...
          <div style={{display:'grid',gridTemplateColumns:'repeat(auto-fill, minmax(300px, 1fr))',gap:10}}>
            {filtered.map((s,i)=>{
              ...
              return (
                <div key={s.id} onClick={()=>{if(s.url&&s.url!=="#")window.open(s.url,"_blank")}}
                  style={{background:'rgba(255,255,255,0.03)',border:'1px solid #1a1a1a',borderRadius:14,padding:'24px',transition:'all 0.3s',display:'flex',flexDirection:'column',justifyContent:'space-between',position:'relative',cursor:s.url&&s.url!=="#"?"pointer":"default"}}
