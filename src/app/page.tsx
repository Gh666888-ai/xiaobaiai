      ...
      <section style={{ position: "relative", minHeight: "calc(100vh - 56px)", display: "flex", alignItems: "center", justifyContent: "center", overflow: "hidden", padding: "82px 24px 72px" }}>
        ...
        <div style={{ position: "relative", zIndex: 10, width: "min(100%, 920px)", textAlign: "center" }}>
          ...
          <div style={{ display: "flex", justifyContent: "center", flexWrap: "wrap", gap: 12, marginTop: 18, opacity: 0, animation: "fadeUp 0.8s ease forwards 1.44s" }}>
            <Link href="/agent-install" style={{ display: "inline-flex", alignItems: "center", justifyContent: "center", minHeight: 44, padding: "0 18px", borderRadius: 10, background: "#e8c96a", color: "#111", fontSize: 14, fontWeight: 950, textDecoration: "none" }}>
              进入 Agent 专区
            </Link>
