...
export const missions: Mission[] = [
  {
    ...
    tagline: "从资料整理、复制提示词、生成页面到导出修改，手把手做出第一份可编辑 PPT。",
    audience: "适合要做工作汇报、课程作业、方案介绍、产品介绍，但不知道怎么让 AI 下手的人。",
    outcome: "完成一份 6 页 PPT 初稿：主题、结构、每页要点、图表建议、演讲备注和可继续修改的导出文件。",
    whyNow: "PPT 是新手最容易感受到 AI 价值的办公场景。关键不是收藏 PPT 工具，而是把资料放对位置、把需求说清楚、把生成结果改到能汇报。",
    minutes: "25-45 分钟",
    stage: "L2 完成任务",
    xp: 65,
    badge: "AI PPT 入门徽章",
    ...
    steps: [
      {
        title: "打开 PPT 生成工具",
        desc: "先准备一个能生成演示稿的工具。新手优先用 Gamma；如果你已经习惯 Canva、WPS 或 PowerPoint，也可以用备用工具。",
        action: "点击打开 Gamma，登录后进入创建页面；如果你已经有可用工具，直接点完成跳到下一步。",
        deliverable: "你能看到可以输入主题、大纲或资料的创建页面。",
        toolAction: {
          label: "打开 Gamma",
          href: "https://gamma.app",
          setupText: "没有账号：打开 Gamma，用邮箱或第三方账号登录。",
          readyText: "已经有账号：直接进入 Create / Generate 页面后点完成。",
        },
        clickPath: ["打开 Gamma", "登录账号", "点击 Create new", "选择 Generate / Paste in text"],
        checklist: ["能正常打开工具", "能进入创建新演示稿页面", "知道备用工具是 Canva / PPT Master / WPS AI"],
        validation: ["页面里有输入主题或粘贴大纲的位置", "你不用再纠结工具，先用一个跑通流程"],
        prompt: "这一步不需要复制提示词。先把工具打开，确认可以进入创建演示稿页面。",
        troubleTips: [
      ...
      {
        title: "把资料整理成 PPT 需求",
        desc: "不要把一堆资料直接扔给工具。先把主题、听众、目标、页数和必须出现的信息整理清楚。",
        action: "把你的资料复制到 AI 对话工具里，让它先整理成一份 PPT 需求单。",
        deliverable: "一份可复制给 PPT 工具的需求单。",
        toolAction: {
          label: "打开 Kimi 整理资料",
          href: "https://kimi.moonshot.cn",
          setupText: "没有 Kimi：也可以用 DeepSeek、豆包、通义千问整理资料。",
          readyText: "已经有资料大纲：可以跳过整理，直接进入下一步。",
        },
        clickPath: ["打开 Kimi / DeepSeek", "粘贴资料", "复制下面提示词", "让 AI 输出 PPT 需求单"],
        checklist: ["写清楚 PPT 主题", "写清楚给谁看", "写清楚想让对方做什么决定", "标出必须出现的数据或案例"],
        validation: ["需求单里有主题、听众、目标、页数、风格和必备内容", "没有敏感信息或已做脱敏"],
        prompt:
      ...
      {
        title: "复制提示词生成 6 页初稿",
        desc: "把整理好的需求单粘贴到 PPT 工具里，让它先生成结构清楚的初稿，不要一开始追求设计完美。",
        action: "回到 Gamma，把下面提示词和你的需求单一起粘贴进去，选择中文和 6 页左右生成。",
        deliverable: "一份 6 页 PPT 初稿。",
        toolAction: {
          label: "回到 Gamma 生成",
          href: "https://gamma.app",
        ...
        checklist: ["页数控制在 6-8 页", "选择中文输出", "先生成初稿，不急着调样式"],
        validation: ["生成结果至少有标题页、背景、问题、方案、计划、总结", "每页有标题和 3-5 个要点"],
        prompt:
          "请根据下面需求生成一份中文 PPT 初稿。\n\n要求：\n- 页数：6 页\n- 风格：简洁、正式、适合汇报\n- 每页只讲一个重点\n- 每页包含：页面标题、3-5个要点、图表/配图建议、演讲备注\n- 不要编造资料里没有的数据\n\n页面结构：\n第1页：标题页，一句话说明核心结论\n第2页：背景，为什么要讲这个问题\n第3页：现状/问题，列出3个关键问题\n第4页：方案，给出3个可执行建议\n第5页：计划，按时间顺序列出下一步\n第6页：总结，给出结论和行动项\n\n我的需求单：\n【粘贴上一步生成的需求单】",
        fixPrompt:
          "这版 PPT 太空泛了。请重写：每页标题改成结论句，删除套话，每页最多 3 个核心要点，补充具体例子或标注“这里需要人工补数据”。",
      },
      {
        title: "检查并修改空泛内容",
        desc: "AI 生成的 PPT 只能算初稿。正式使用前必须删空话、补数据、改成适合听众的表达。",
        action: "逐页检查标题、数据、案例和行动项；发现空泛内容就复制补救提示词继续修改。",
        deliverable: "一份经过人工检查的 PPT 修改版。",
