...
export const missions: Mission[] = [
  ...
  },
  {
    ...
    steps: [
      {
        title: "把想法压成 60 秒剧情",
        desc: "不要一上来做 12 分钟长剧。先把题材、主角、冲突和结尾压成 60 秒。",
        action: "用 AI 生成 1 段 60 秒剧情梗概，必须包含主角、目标、冲突、反转或结尾。",
        deliverable: "一段 150 字以内的 60 秒剧情梗概。",
        checklist: ["只有一个主角", "只有一个冲突", "结尾明确", "不是空泛世界观"],
      ...
      },
      {
        ...
        prompt:
          "请把下面 60 秒剧情拆成 8 个漫剧分镜。\n\n输出表格字段：镜头编号、时长、画面、人物动作、台词/旁白、画面生成提示词。\n\n剧情：\n【粘贴剧情】",
      ...
      {
        title: "生成配音台词和剪辑清单",
        desc: "先把台词、旁白、音效和剪辑节奏写清楚，即使暂时不生成视频，也能交给剪映或其他工具继续做。",
        action: "整理每个镜头的配音台词、音效、字幕和剪辑备注。",
        deliverable: "一份配音台词表和剪辑清单。",
        checklist: ["台词口语化", "每个镜头有字幕", "有音效或背景音乐建议", "有剪辑节奏"],
        validation: ["台词能直接配音", "剪辑清单能交给剪映继续做"],
        prompt:
          "请根据 8 镜头分镜，生成配音和剪辑清单。\n\n字段：镜头、旁白/台词、字幕、音效、背景音乐建议、剪辑备注。\n\n分镜：\n【粘贴分镜表】",
      },
      {
        title: "整理样片复盘",
        desc: "最后留下完整样片资料，下次才能从 60 秒扩展到 3 分钟或系列内容。",
        action: "复制复盘模板，记录题材、分镜、角色提示词、工具和最容易翻车的点。",
