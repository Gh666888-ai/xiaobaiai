  ...
  },
  {
    ...
    subjects: [
      ...
      },
      {
        id: "install-agent",
        title: "安装 Agent 工具",
        description: "安装工程 Agent、AI IDE、插件、产品方官方桌面助手或多模型桌面客户端，先跑通一个小样例。",
        goal: "能分清 Agent 本体、桌面端 App 和模型 API，并完成一次启动验证。",
        level: "practice",
        minutes: 130,
        prerequisites: ["agent-concepts"],
        tutorials: [
          { id: "agent-install-map", title: "先选安装路线", kind: "check", minutes: 12, deliverable: "桌面端 / CLI / 插件选择卡", href: "/agent-install" },
          { id: "install-official-agent-desktop", title: "安装 Codex 产品方官方桌面端", kind: "tool", minutes: 22, deliverable: "Codex App 能读项目", href: "/agent-install/codex-app" },
          { id: "install-engineering-agent", title: "安装 Claude Code / Codex CLI / Gemini CLI / Qwen Code", kind: "tool", minutes: 32, deliverable: "工程 Agent 能启动", href: "/agent-install/claude-code" },
          { id: "install-ide-agent-plugin", title: "安装 Copilot / Cline / Continue / Junie 插件", kind: "tool", minutes: 28, deliverable: "IDE Agent 插件能读项目", href: "/agent-install/github-copilot-agent" },
          { id: "install-openclaw-desktop", title: "安装 OpenClaw 和第三方桌面端", kind: "tool", minutes: 30, deliverable: "OpenClaw 或 ClawX 可用", href: "/agent-install/openclaw" },
          { id: "install-official-desktop-apps", title: "安装 ChatGPT / Claude 官方桌面助手", kind: "tool", minutes: 20, deliverable: "官方桌面助手能回复", href: "/agent-install/chatgpt-desktop" },
          { id: "install-model-desktop-client", title: "设置第三方多模型客户端", kind: "tool", minutes: 25, deliverable: "模型 API 或本地模型跑通", href: "/agent-install/cherry-studio" },
          { id: "install-local-model-desktop", title: "安装 LM Studio / Jan / GPT4All / Ollama", kind: "tool", minutes: 25, deliverable: "本地模型能回答", href: "/agent-install/lm-studio" },
