...
export const professionSkillTracks: ProfessionSkillTrack[] = [
  ...
  },
  {
    ...
    preferredNames: ["skill-vetter", "github", "Cloudflare Skills", "Superpowers Chrome", "AgenticFlow Skill", "Agent Browser", "tavily-search", "wacli", "代码审查助手", "API文档生成", "环境部署助手"],
    preferredTags: ["安全", "GitHub", "Cloudflare", "Chrome", "MCP", "代码", "审查", "浏览器", "搜索", "联网", "CLI", "shell", "API", "部署"],
