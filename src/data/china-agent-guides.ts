...
const claudeCodeChinaGuide = [
  ...
  "    claude",
  "",
  "如果出现 Choose the text style that looks best with your terminal：",
  "这不是报错，是 Claude Code 第一次启动让你选终端主题。默认选中的 Dark mode 可以直接用，按回车继续。",
  "如果想换主题，用键盘上下方向键选择；以后想改，在 Claude Code 里输入 /theme。",
  "",
  "第一次打开后，先输入：",
  "    请先告诉我你能做什么，不要修改我的文件。",
  "",
  "在真实项目里用时，先进入项目文件夹，再启动：",
  "    cd 你的项目文件夹路径",
  "    claude",
  "",
  "进入项目后第一句话建议输入：",
  ...
  "",
  "Unable to connect to Anthropic services：Claude Code 已启动，但连不上 Anthropic 官方服务；国内用户先配置 ANTHROPIC_BASE_URL 到 DeepSeek 兼容接口。",
  "",
